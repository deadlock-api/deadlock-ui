...
Deadlock UI is an open-source Web Components library for [Deadlock](https://store.steampowered.com/app/1422450/Deadlock/) game items. Item data and images are fetched directly from the [Deadlock API](https://deadlock-api.com/) (no local assets or configuration needed).
